    ...
    <div className="flex-1 overflow-y-auto">
      {filteredChats.length === 0 ? (
        <div className="flex flex-col items-center justify-center h-64 text-gray-400 dark:text-gray-500">
          ...
          <p className="text-xs mt-2">Чаты появятся после подключения</p>
        </div>
      ) : (
        ...
        <div key={chat.id}>
          <div
            ...
            className="flex items-center gap-3 p-2.5 mx-2 hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer transition-colors"
          >
          {/* Avatar */}
          <div className="relative flex-shrink-0">
            <div className="w-13 h-13 rounded-full overflow-hidden bg-gray-100 dark:bg-gray-800 flex items-center justify-center flex-shrink-0">
              <div className={`w-full h-full flex items-center justify-center ${getAvatarGradient(chat.name)} text-white font-semibold text-base`}>
